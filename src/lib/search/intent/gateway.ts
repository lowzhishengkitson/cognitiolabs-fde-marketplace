...
Omit unspecified fields. Explicit numeric constraints and named CPU/GPU requirements are hard constraints. Preserve named CPU/GPU text in cpuQuery/gpuQuery; do not invent component names. Do not invent numeric thresholds for qualitative words. Qualitative requests such as lightweight, programming, student, gaming, or portable may become useCase/preferences. Superlatives such as cheapest, lightest, largest screen, most RAM, most storage, and highest battery health must become deterministic sorts. Never return listing IDs or catalogue facts. Return JSON only.` },
