...
type SearchResponse = { interpretedIntent: SearchIntent; retrieval: "embedding" | "local-fallback"; listings: Listing[]; scores: { id: string; score: number }[] };
